...
namespace com.drew.metadata.exif
{
	...
	public class KyoceraDirectory : AbstractDirectory 
	{
        ...
        protected static readonly ResourceBundle BUNDLE = new ResourceBundle("KyoceraMarkernote");
        protected static readonly Dictionary<int, string> tagNameMap = FillTagMap(Type.GetType("com.drew.metadata.exif.KyoceraDirectory"), BUNDLE);
